...
class LogoutButton extends React.Component {
  handleLogout = () => {
		...
		this.props.addToastrMessage('success', 'Success', 'You have been successfully logged out');
  }
	render() {
		return (
			<svg
...
LogoutButton.propTypes = {
	...
	addToastrMessage: PropTypes.func.isRequired
}
...
export default connect(mapStateToProps, {logoutUser, addToastrMessage})(LogoutButton);
